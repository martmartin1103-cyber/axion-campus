...
export default function LandingPage() {
  ...
  useEffect(() => {
    setMounted(true)
    // Si session étudiant active → diagnostic ou résultats
    ...
    <div className="min-h-screen bg-[#060f1e] flex flex-col overflow-hidden relative">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 text-center pb-20">
        ...
        <p className="text-slate-400 text-lg max-w-xl leading-relaxed mb-14">
          10 questions. 5 dimensions. Un score sur 1000 et un certificat
          reconnu par votre école.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full max-w-2xl">
          ...
          >
            ...
            <p className="text-white/60 text-sm leading-relaxed">
              Entrez votre code d'accès fourni par votre école et démarrez l'évaluation.
            </p>
          ...
          >
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Visualisez les KPIs, résultats et niveaux de satisfaction de votre promotion.
            </p>
        ...
        <div className="flex items-center gap-8 mt-14 text-slate-500">
          {[
            { n: '5', label: 'dimensions évaluées' },
            { n: '10', label: 'questions ciblées' },
            { n: '1000', label: 'points max' },
          ].map((item) => (
